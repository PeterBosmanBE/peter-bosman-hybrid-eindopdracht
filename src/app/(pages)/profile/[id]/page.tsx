      ...
      <div className="container mx-auto px-4 max-w-5xl -mt-20 sm:-mt-24 relative z-10">
        <div className="bg-white rounded-3xl shadow-xl p-6 sm:p-10 flex flex-col sm:flex-row items-center sm:items-end gap-6 mb-12 border border-gray-100">
          <Avatar className="w-32 h-32 sm:w-40 sm:h-40 border-4 border-white shadow-md bg-white">
            ...
            <AvatarFallback className="text-4xl bg-gray-100 text-gray-600">{userProfile.name.charAt(0)}</AvatarFallback>
          </Avatar>
        ...
        <div className="mb-16">
          ...
          {userAudiobooks.length === 0 ? (
            <div className="bg-white rounded-2xl border border-dashed border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-500 font-medium">This user hasn&apos;t published any audiobooks yet.</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10">
              {userAudiobooks.map((audiobook) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 line-clamp-1 font-medium">By {audiobook.author}</p>
                </Link>
              ))}
            </div>
          )}
        ...
        <div>
          ...
          {userPodcasts.length === 0 ? (
            <div className="bg-white rounded-2xl border border-dashed border-gray-200 p-12 text-center">
              ...
              <p className="text-gray-500 font-medium">This user hasn&apos;t published any podcasts yet.</p>
            </div>
          ) : (
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-x-6 gap-y-10">
              {userPodcasts.map((podcast) => (
                ...
                >
                  ...
                  <p className="text-sm text-gray-500 line-clamp-1 font-medium">By {podcast.author}</p>
                </Link>
              ))}
            </div>
          )}
