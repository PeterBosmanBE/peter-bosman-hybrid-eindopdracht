    ...
    >
      <div className="flex flex-col h-full">
        ...
        <nav className="flex-1 px-4 py-6">
          <p
            className="px-3 mb-3 text-xs font-semibold uppercase"
          ...
          <p
            className="px-3 mt-8 mb-3 text-xs font-semibold uppercase"
            style={{ color: "rgba(255,255,255,0.4)" }}
          >
            Quick Links
          </p>
              ...
              >
                ...
                >
                  ...
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth="2"
                    d="M16.24 7.76l-4.24 8.48-1.41-1.41-1.41-1.41 8.48-4.24z"
                  />
                </svg>
                Discover
              </Link>
