...
export default function CreateShow({ setCreateOpen }: { setCreateOpen: (open: boolean) => void }) {
  ...
  const isCreating = createPodcastMutation.isPending || createAudiobookMutation.isPending;
        ...
        <DialogContent>
                  ...
                  <div className="space-y-3">
                    <div className="space-y-1">
                      <p className="text-xs font-semibold uppercase" style={{ color: "#666666" }}>
                        Title
                      </p>
                      <Input
                        value={newTitle}
                  ...
                  <div className="grid gap-2 sm:grid-cols-2">
                    ...
                    <Button className="w-full" disabled={!canCreate || isCreating} onClick={handleCreateContent}>
                      {isCreating ? "Creating..." : `Create ${newType === "podcast" ? "Podcast" : "Audiobook"}`}
                    </Button>
                  </div>
                </DialogContent>
    </div>
